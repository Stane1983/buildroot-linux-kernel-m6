...
#define CLR_CBUS_REG_MASK(reg, mask)   WRITE_CBUS_REG(reg, (READ_CBUS_REG(reg)&(~(mask))))
...
#define MESON_PERIPHS1_VIRT_BASE    0xf11084dc  //uart1 0x2137<<2 + IO_CBUS_BASE, uart0 0x2130
#define MESON_PERIPHS1_PHYS_BASE    0xc11084dc
#endif
...
#define MESON_PERIPHS1_VIRT_BASE    0xc11084dc
#define MESON_PERIPHS1_PHYS_BASE    0xc11084dc
#endif
