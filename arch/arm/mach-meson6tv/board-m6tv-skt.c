/*
 * arch/arm/mach-meson6tv/board-m6tv-skt.c
 *
...
static void m6tvskt_set_vccx2(int power_on)
{
	if (power_on) {
		//restore_pinmux();
...
static struct resource amlogic_dvb_fe_resource[]  = {
	...
	[7] = {
     ...
     #elif (defined CONFIG_AM_M1_DEMOD)
	[0] = {
                .start = 0,                                 //DTV demod: M1=0, MXL101=2
                .end   = 0,
                .flags = IORESOURCE_MEM,
                .name  = "dtv_demod0"
        },
...
static int m6tvskt_dvb_init(void)
{
	{
//#define FEC_B
...
static int m6tvskt_smc_init(void)
{
...
MACHINE_START(MESON6TV_SKT, "Amlogic Meson6TV socket board")
