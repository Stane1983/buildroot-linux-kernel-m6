...
#define P_HHI_DEMOD_PLL_CNTL    (volatile unsigned long *)CBUS_REG_ADDR(HHI_VDEC_CLK_CNTL)//(volatile unsigned long *)CBUS_REG_ADDR(HHI_DEMOD_PLL_CNTL)       /*(volatile unsigned long *)0xc11041b4*/
#define P_HHI_DEMOD_PLL_CNTL2   (volatile unsigned long *)CBUS_REG_ADDR(HHI_MIPI_PHY_CLK_CNTL)//(volatile unsigned long *)CBUS_REG_ADDR(HHI_DEMOD_PLL_CNTL2)     /*(volatile unsigned long *)0xc11041b8*/
#define P_HHI_DEMOD_PLL_CNTL3   (volatile unsigned long *)CBUS_REG_ADDR(HHI_VDEC_CLK_CNTL)//(volatile unsigned long *)CBUS_REG_ADDR(HHI_DEMOD_PLL_CNTL3)     /*(volatile unsigned long *)0xc11041bc*/
...
int dtmb_set_ch(struct aml_demod_sta *demod_sta,
		struct aml_demod_i2c *demod_i2c, 
		struct aml_demod_dtmb *demod_dvbt);

int atsc_set_ch(struct aml_demod_sta *demod_sta,
		struct aml_demod_i2c *demod_i2c, 
		struct aml_demod_atsc *demod_dvbt);
