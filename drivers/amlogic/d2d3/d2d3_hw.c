...
static unsigned int d2d3_reg_table[D2D3_REG_NUM]={
        ...
        0x00ff001e,0x04103fc0,0x008700c3,0x40000000,0x08081300,0x0606403f,0x0606403f,0x00012020,
        //0x2b10    0x2b11      0x2b12     0x2b13     0x2b14     0x2b15     0x2b16    0x2b17
        0x00000000,0x08000600,0x06000400,0x08000600,0x000c0c10,0x800c0c10,0x00404013,0x008700f0,
        //0x2b18    0x2b19      0x2b1a     0x2b1b     0x2b1c     0x2b1d     0x2b1e    0x2b1f
        0x000000a3,0xbb2dc0c0,0xbb1ec0c0,0x42427777,0xc010c004,0x06cc0000,0x58381808,0x58381808,
        //0x2b20    0x2b21      0x2b22     0x2b23     0x2b24     0x2b25     0x2b26    0x2b27
        0x00008080,0x00000000,0x00000000,0x00000000,0x000000b3,0x00ef0000,0x00860000,0x008600ef,
        //0x2b28    0x2b29      0x2b2a     0x2b2b     0x2b2c     0x2b2d     0x2b2e    0x2b2f
        0x000000b3,0x00ef0000,0x00860000,0x00000000,0x00000004,0x00000000,0x00000000,0x00000100,
        ...
        0x00000000,0x00000000,0x00520001,0x00000002,0x00000000,0x00000000,0x00000000,0x00000000,
};
...
inline int d2d3_depth_adjust(unsigned int depth)
{
        if(depth>128 || depth < 2)
                return 1;
        Wr_reg_bits(D2D3_D2P_PARAM_2,depth,D2P_PG0_BIT,D2P_PG0_WID);
        Wr_reg_bits(D2D3_D2P_PARAM_2,depth,D2P_PG1_BIT,D2P_PG1_WID);
        Wr_reg_bits(D2D3_D2P_PARAM_3,depth,D2P_NG0_BIT,D2P_NG0_WID);
        Wr_reg_bits(D2D3_D2P_PARAM_3,depth,D2P_NG1_BIT,D2P_NG1_WID);
        return 0;
}

static inline void d2d3_enable_path(bool enable, d2d3_param_t *parm)
{
 ...
 */
void d2d3_enable_hw(bool enable,d2d3_param_t *parm)
{
        d2d3_enable_path(enable,parm);
        if(enable){
