...
#define CIPLUS_WR_OUTOUT_CF0            0x0000040f      //WR
...
#define CIPLUS_RD_OUTOUT_CF1            0x0001010f 
...
#define CIPLUS_WR_BUS_CONFIG ( \
                               ...
                               |(2  << bus_sel_chang_point_1_bit ) \
                               |(8  << bus_width_0_bit) \
                               |(5  << bus_start_pin_0_bit ) \
                               |(2  << bus_sel_chang_point_0_bit ) \
                             )
// For Attr Read Bus
...
#define CIPLUS_IOWR_OUTOUT_CF3            0x0003040f       // IOWR
// For IO Read Signal
#define CIPLUS_IORD_OUTOUT_CF0            0x0000ffff
#define CIPLUS_IORD_OUTOUT_CF1            0x0001ffff
#define CIPLUS_IORD_OUTOUT_CF2            0x0002010f
...
#define CIPLUS_WAIT_IRQ_CONFIG ( \
                               ...
                               |(7 << no_wait_condition_check_point_bit) \
                             )
