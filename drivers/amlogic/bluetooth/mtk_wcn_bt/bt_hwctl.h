...
#define BT_HWCTL_INFO(f, s...)   printk(KERN_DEBUG "BTHWCTL: " f, ## s)
#define BT_HWCTL_ALERT(f, s...)  printk(KERN_DEBUG "BTHWCTL: " f, ## s)
#define BT_HWCTL_ERR(f, s...)    printk(KERN_DEBUG "BTHWCTL: " f, ## s)
#if BT_HWCTL_DEBUG
#define BT_HWCTL_DBG(f, s...)    printk(KERN_DEBUG "BTHWCTL: " f, ## s)
#else
